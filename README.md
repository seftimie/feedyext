...
4. **Install the Chrome Extension**
   - Abre Google Chrome y pincha sobre el icono de puzzle (extensiones) que se encuentra en la parte superior derecha de la ventana
   - Una vez abierto, habilita el modo desarrollador en la parte superior derecha

   - Follow the instructions in the project repository to install the extension.
